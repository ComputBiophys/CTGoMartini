...
class Multi_allbonds(Interaction):
    def __init__(self, nonbonded_cutoff=1.1 * mm.unit.nanometer, use_sigma_eps=True):
        super().__init__(name='multi_allbonds',
    ...
    def add_interaction(self, state, category, fields, base_atom_index=0, offset=-1):
        fields_used = False
    ...
    def get_exception(self, atoms, category, fields, base_atom_index=0, offset=-1):
