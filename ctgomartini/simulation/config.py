"""
Simulation configuration module for CTGoMartini.
...
class SimulationConfig:
    """
    Configuration class for storing and parsing simulation input parameters.
...
def load_config(input_file: str) -> SimulationConfig:
    """
    Load simulation configuration from an input file.
    
    Args:
        input_file: Path to the input parameter file.
        
    Returns:
        Parsed simulation configuration object with all settings as attributes.
