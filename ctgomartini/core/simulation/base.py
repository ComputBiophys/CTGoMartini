...
Provides the BaseRunner class with common functionality for MD and REMD simulations,
...
class BaseRunner(ABC):
    ...
    def __init__(self, inpfile: str) -> None:
        ...
        self.platform, self.platform_properties = load_platform(self.inputs)
    ...
    def generate_topology(self) -> tuple[System, Topology, mm.Vec3]:
        ...
        if self.inputs.pcouple == "yes":
            if self.inputs.p_type == "isotropic":
                ...
                raise Exception("Unsupported barostat type: ", self.inputs.p_type)
