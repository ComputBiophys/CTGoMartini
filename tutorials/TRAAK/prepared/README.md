...
```bash
ctgomartinize -s 7LJB_clean.pdb 4WFE_clean.pdb -m 7LJB_clean.map 4WFE_clean.map -mol Up Down -mbmol TRAAK -dssp -ff martini3001 -method exp -other_params="-nt -cys 0.25"
```
